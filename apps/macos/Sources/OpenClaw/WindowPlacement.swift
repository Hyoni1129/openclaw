...
enum WindowPlacement {
  ...
  static func anchoredBelowFrame(size: NSSize, anchor: NSRect, padding: CGFloat, in bounds: NSRect)
    -> NSRect
  {
    if bounds == .zero {
  ...
  static func ensureOnScreen(
    ...
    let targetScreens =
      NSScreen.screens.isEmpty ? [NSScreen.main].compactMap(\.self) : NSScreen.screens
